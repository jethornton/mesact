...
inputs = [{'Not Used':'Select'},
	...
	{'Jog':[{'X Axis':['Jog X Plus', 'Jog X Minus', 'Jog X Enable']},
		{'Y Axis':['Jog Y Plus', 'Jog Y Minus', 'Jog Y Enable']},
		{'Z Axis':['Jog Z Plus', 'Jog Z Minus', 'Jog Z Enable']},
		{'A Axis':['Jog A Plus', 'Jog A Minus', 'Jog A Enable']},
		{'B Axis':['Jog B Plus', 'Jog B Minus', 'Jog B Enable']},
		{'C Axis':['Jog C Plus', 'Jog C Minus', 'Jog C Enable']},
		{'U Axis':['Jog U Plus', 'Jog U Minus', 'Jog U Enable']},
		{'V Axis':['Jog V Plus', 'Jog V Minus', 'Jog V Enable']},
		{'W Axis':['Jog W Plus', 'Jog W Minus', 'Jog W Enable']}
	]},
